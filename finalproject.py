...
def system():
    ...
    def add():
        ...
        if ord1=="" or french1=="" or pizza1=="" or  burger1==""or noodles1==""or ice1=="" or drinks1=="" or cost1=="" or subtotal1=="" or tax1=="" or service1=="" or  total1=="":
            ...
            conn.execute('INSERT INTO RECORD (ordno, fr, piz, bur ,noo, ice ,dr ,ct ,sb ,tax, sr, tot) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)',(ord1,french1,pizza1, burger1,noodles1, ice1, drinks1,cost1,subtotal1,tax1,service1,total1));
            conn.commit()
    ...
    ### Labels
    #items
    ordlbl=Label(leftframe,font=('aria',16,'bold'),text="Order No.",fg="black",bd=10,anchor=W).grid(row=1,column=0)
    ordtxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=orderno).grid(row=1,column=1)
    #french fries
    frlbl=Label(leftframe,font=('aria',16,'bold'),text="French Fries",fg="black",bd=10,anchor=W).grid(row=2,column=0)
    frtxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=french).grid(row=2,column=1)
    #Pizza
    pizlbl=Label(leftframe,font=('aria',16,'bold'),text="Pizza",fg="black",bd=10,anchor=W).grid(row=3,column=0)
    piztxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=pizza).grid(row=3,column=1)
    #burger
    burlbl=Label(leftframe,font=('aria',16,'bold'),text="Burger",fg="black",bd=10,anchor=W).grid(row=4,column=0)
    burtxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=burger).grid(row=4,column=1)
    #Hakka Noodles
    noolbl=Label(leftframe,font=('aria',16,'bold'),text="Noodles",fg="black",bd=10,anchor=W).grid(row=5,column=0)
    nootxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=noodles).grid(row=5,column=1)
    #icecream
    icelbl=Label(leftframe,font=('aria',16,'bold'),text="Ice Cream",fg="black",bd=10,anchor=W).grid(row=6,column=0)
    icetxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=icecream).grid(row=6,column=1)
    #drinks
    drinklbl=Label(leftframe,font=('aria',16,'bold'),text="Drinks",fg="black",bd=10,anchor=W).grid(row=1,column=2)
    drinktxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=drinks).grid(row=1,column=3)
    #cost
    costlbl=Label(leftframe,font=('aria',16,'bold'),text="Cost",fg="blue",bd=10,anchor=W).grid(row=2,column=2)
    costtxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=cost).grid(row=2,column=3)
    #subtotal
    sublbl=Label(leftframe,font=('aria',16,'bold'),text="Subtotal",fg="blue",bd=10,anchor=W).grid(row=3,column=2)
    subtxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=subtotal).grid(row=3,column=3)
    #tax
    taxlbl=Label(leftframe,font=('aria',16,'bold'),text="Tax",fg="blue",bd=10,anchor=W).grid(row=4,column=2)
    taxtxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=tax).grid(row=4,column=3)
    #service
    servicelbl=Label(leftframe,font=('aria',16,'bold'),text="Service",fg="blue",bd=10,anchor=W).grid(row=5,column=2)
    servicetxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=service).grid(row=5,column=3)
    #total
    totallbl=Label(leftframe,font=('aria',16,'bold'),text="Total",fg="blue",bd=10,anchor=W).grid(row=6,column=2)
    totaltxt=Entry(leftframe,font=('aria',16,'bold'),bd=6,insertwidth=4,bg="#e67f30",justify='right',textvariable=total).grid(row=6,column=3)
    #---button--
    
    #totalbutton
    totbtn=Button(leftframe,font=('vardana',16,'bold'),text="Total",bg="blue",fg="white",bd=10,padx=5,pady=5,width=10,command=tottal).grid(row=8,column=1)
    #resetbutton
    resetbtn=Button(leftframe,font=('vardana',16,'bold'),text="Reset",bg="blue",fg="white",bd=10,padx=5,pady=5,width=10,command=reset).grid(row=8,column=2)
    #exitbutton
    exitbtn=Button(leftframe,font=('vardana',16,'bold'),text="Exit",bg="#e67f30",fg="black",bd=10,padx=5,pady=5,width=10,command=exit).grid(row=8,column=3)
    #Add  recordbutton
    addbtn=Button(leftframe,font=('vardana',16,'bold'),text="Add",bg="blue",fg="white",bd=10,padx=5,pady=5,width=10,command=add).grid(row=10,column=0)
    #Deleterecordbutton
    deletebtn=Button(leftframe,font=('vardana',16,'bold'),text="Delete Record",bg="blue",fg="white",bd=10,padx=5,pady=5,width=10,command=Delete).grid(row=10,column=3)
    ########################### feedback form ################################
    ...
    def feedbackk():
        ...
        nametxt=Entry(feed,font=('vardana',15),bd=6,insertwidth=2,bg="white",justify='right',textvariable=name).place(x=15,y=185)
        #email
        emaillbl=Label(feed,font=('vardana',15),text="Email:-",fg="black",bd=10,anchor=W).place(x=280,y=150)
        emailtxt=Entry(feed,font=('vardana',15),bd=6,insertwidth=2,bg="white",justify='right',textvariable=email).place(x=285,y=185)
        ###checkbutton
        ratelbl=Label(feed,font=('vardana',15),text="How would you rate us?",fg="black",bd=10,anchor=W).place(x=10,y=215)
        checkvar1=StringVar()
        checkvar2=StringVar()
        checkvar3=StringVar()
        checkvar4=StringVar()
        ...
        #button
        submit=Button(feed,font=("vardana",15),text="Submit",fg="black",bg="green",bd=2,command=submit).place(x=145,y=430)
        cancel=Button(feed,font=("vardana",15),text="Cancel",fg="black",bg="red",bd=2,command=cancel).place(x=245,y=430)
        feed.mainloop()
    #Feedbackbutton
    feedbtn=Button(leftframe,font=('vardana',16,'bold'),text="Feedback",fg="black",bg="#e67f30",bd=10,padx=10,pady=10,width=15,command=feedbackk).grid(row=10,column=1,columnspan=2)  
    ##################### Menu card ################################
    def menu():
        roott=Tk()
        ...
        roott.mainloop()
    #menubutton
    menubtn=Button(leftframe,font=('vardana',16,'bold'),text="Menu",bg="#e67f30",fg="black",bd=10,padx=5,pady=5,width=10,command=menu).grid(row=8,column=0)
